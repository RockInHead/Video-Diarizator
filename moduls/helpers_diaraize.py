...
GLOBAL_BASE_DIR = os.path.join(SYSTEM_DRIVE, "tempDiscription")
GLOBAL_AUDIO_DIR = os.path.join(GLOBAL_BASE_DIR, "tempAudio")
GLOBAL_YAML_DIR = os.path.join(GLOBAL_BASE_DIR, "tempYAML")
LANGUAGES = {
...
langs_to_iso = {
    "af": "afr", "am": "amh", "ar": "ara", "as": "asm", "az": "aze", "ba": "bak", "be": "bel", "bg": "bul", "bn": "ben", "bo": "tib", 
    "br": "bre", "bs": "bos", "ca": "cat", "cs": "cze", "cy": "wel", "da": "dan", "de": "ger", "el": "gre", "en": "eng", "es": "spa", 
    "et": "est", "eu": "baq", "fa": "per", "fi": "fin", "fo": "fao", "fr": "fre", "gl": "glg", "gu": "guj", "ha": "hau", "haw": "haw", 
    "he": "heb", "hi": "hin", "hr": "hrv", "ht": "hat", "hu": "hun", "hy": "arm", "id": "ind", "is": "ice", "it": "ita", "ja": "jpn", 
    "jw": "jav", "ka": "geo", "kk": "kaz", "km": "khm", "kn": "kan", "ko": "kor", "la": "lat", "lb": "ltz", "ln": "lin", "lo": "lao", 
    "lt": "lit", "lv": "lav", "mg": "mlg", "mi": "mao", "mk": "mac", "ml": "mal", "mn": "mon", "mr": "mar", "ms": "may", "mt": "mlt",
    "my": "bur", "ne": "nep", "nl": "dut", "nn": "nno", "no": "nor", "oc": "oci", "pa": "pan", "pl": "pol", "ps": "pus", "pt": "por", 
    "ro": "rum", "ru": "rus", "sa": "san", "sd": "snd", "si": "sin", "sk": "slo", "sl": "slv", "sn": "sna", "so": "som", "sq": "alb",
    "sr": "srp", "su": "sun", "sv": "swe", "sw": "swa", "ta": "tam", "te": "tel", "tg": "tgk", "th": "tha", "tk": "tuk", "tl": "tgl",
    "tr": "tur", "tt": "tat", "uk": "ukr", "ur": "urd", "uz": "uzb", "vi": "vie", "yi": "yid", "yo": "yor", "yue": "yue", "zh": "chi"
}
...
def get_realigned_ws_mapping_with_punctuation(word_speaker_mapping, max_words_in_sentence=50):
    ...
    while k < len(word_speaker_mapping):
        ...
        if (k < wsp_len - 1 and speaker_list[k] != speaker_list[k + 1] and not is_word_sentence_end(k)):
            ...
            right_idx = (get_last_word_idx_of_sentence(k, words_list, max_words_in_sentence - k + left_idx - 1)
                if left_idx > -1 else -1)
...
def get_speaker_aware_transcript(sentences_speaker_mapping) -> str:
    transcript = ""
    previous_speaker = sentences_speaker_mapping[0]["speaker"]
    transcript += f"{previous_speaker}: "
...
def find_numeral_symbol_tokens(tokenizer):
    ...
    for token, token_id in tokenizer.get_vocab().items():
        ...
        if has_numeral_symbol: numeral_symbol_tokens.append(token_id)
...
def _get_next_start_timestamp(word_timestamps, current_word_index, final_timestamp):
    ...
    while current_word_index < len(word_timestamps) - 1:
        if word_timestamps[next_word_index].get("start") is None:
            ...
            next_word_index += 1
            if next_word_index == len(word_timestamps): return final_timestamp

        else: return word_timestamps[next_word_index]["start"]
...
def filter_missing_timestamps(word_timestamps, initial_timestamp=0, final_timestamp=None):
    ...
    for i, ws in enumerate(word_timestamps[1:], start=1):
        ...
        if ws["word"] is not None: result.append(ws)
...
def cleanup(path: str):
    ...
    else: raise ValueError(f"Path {path} is not a file or dir.")
...
def process_language_arg(language: str, model_name: str):
    ...
    if language is not None:
        ...
        if model_name.endswith(".en") and language != "en": raise ValueError(f"{model_name} is an English-only model but choosen language is '{language}'")
