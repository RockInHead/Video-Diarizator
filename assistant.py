...
def analyze_candidate(assistant_id, interview_text):
    ...
    1. Ключевые навыки и опыт. Укажи основные профессиональные навыки и опыт, которые описаны в резюме и подтверждены в транскрипции.
    2. Образование. Опиши уровень образования кандидата и любые ключевые учебные достижения.
    3. Профессиональные достижения. Укажи конкретные достижения из резюме и интервью, включая результаты и проекты.
    4. Соответствие квалификации требованиям вакансии. На основе обеих частей текста оцени, насколько кандидат соответствует требованиям вакансии.
    5. Мотивация и карьерные цели. Укажи карьерные цели кандидата и его мотивацию, описанную в резюме и интервью.
    """
